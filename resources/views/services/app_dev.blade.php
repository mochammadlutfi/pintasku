...
<section class="about-area bgtemplate"> 
     <div class="container" >
            <div class="row">
                <div class="col-md-7">
                    <div class="about-content-table">
                        <div class="about-content-table-sell">
                            ...
                            <h2 class="judul col-md-12"><br>App Development <span></span></h2>
                ...
                <div class="col-md-5">
                    <div class="gbrhead">
                    <img src="{{asset('assets/img/bg/appdev.png')}}" class="img-fluid" alt="https://www.freepik.com/free-photos-vectors/banner">
                    </div>
