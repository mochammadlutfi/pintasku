...
<div class="content">
    <nav class="breadcrumb bg-white push">
        ...
        <span class="breadcrumb-item active">Riview & Checkout</span>
    </nav>
    <div class="block">
        <div class="block-content pb-15">
            <form id="form-checkout" method="post" onsubmit="return false;">
                ...
                <div class="row">
                    <div class="col-lg-8">
                        @if(Session::get('produk.attributes.tipe') == 'Web Application')
                            <div class="row mb-3">
                                <div class="col-lg-12">
                                    <div class="content-heading mb-0 pt-0">Lisensi Web Application</div>
                                </div>
                            </div>
                        @endif
                        {{-- Tampilkan Form Informasi Pendaftaran Domain Apbila Terdapat Session Domain --}}
